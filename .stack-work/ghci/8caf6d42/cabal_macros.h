...
/* package minimax-0.1.0.0 */
#ifndef VERSION_minimax
#define VERSION_minimax "0.1.0.0"
#endif /* VERSION_minimax */
#ifndef MIN_VERSION_minimax
#define MIN_VERSION_minimax(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_minimax */
...
#define CURRENT_PACKAGE_KEY "minimax-0.1.0.0-7YMKN1peanX7tnBPjUN7Io"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "minimax-0.1.0.0-7YMKN1peanX7tnBPjUN7Io"
